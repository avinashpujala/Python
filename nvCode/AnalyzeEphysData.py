...
def import10ch(filename):
    """ Imports *.10ch file and parses it into matlab-structure-like arrays: data['t'][:], etc.
    """
    f = open(filename, 'rb')
...
=======
    ...
    #            ('ch6',np.float32),
    #            ('2pTrigger',np.float32)])
>>>>>>> c7e3014773493189ff879ca68114f6caf7e1c7cd
...
def getStims(stimCh,slopeThr,ampThr,):
