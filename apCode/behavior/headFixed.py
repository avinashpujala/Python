...
def fishImgsForMidline(images, filtSize=2.5, otsuMult=1):
    """
    ...
    # I_fish = compute(*[delayed(fishImgForMidline)(img, filtSize, otsuMult) for img in images],
